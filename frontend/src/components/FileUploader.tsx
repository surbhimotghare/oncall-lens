      ...
      >
        ...
        <div className="space-y-4">
          <div className={`mx-auto w-16 h-16 rounded-full flex items-center justify-center transition-all duration-300 ${
            isDragOver ? 'bg-blue-100 dark:bg-blue-900/50' : 'bg-gray-100 dark:bg-slate-700'
          }`}>
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm">
              Drag and drop files here, or <span className="text-blue-600 dark:text-blue-400 font-medium">click to browse</span>
            </p>
