  ...
  <div className="flex flex-col items-center justify-center h-64 text-center space-y-4">
    ...
    <div>
      ...
      <p className="text-muted mt-1">
        Your incident analysis will appear here once you upload files and click &ldquo;Analyze&rdquo;
      </p>
    </div>
  </div>
);
...
export default function AnalysisResult({ result, isLoading, error, confidence }: AnalysisResultProps) {
  if (error) {
    return (
